...
/**
 * Authentic brand marks (sourced from simple-icons).
 * Rendered with `fill="currentColor"` so the surrounding tile can tint
 * them with the official brand color via `style={{ color: m.color }}`.
 */
...
/**
 * A ready-made colorful rounded tile with the model's brand icon inside.
 * Drop this into logo strips / proof rows for an instantly recognizable
 * authentic look.
 */
export function ModelTile({
  ...
  return (
    ...
    >
      <ModelIcon id={id} className="h-[52%] w-[52%]" />
    </span>
  );
}
