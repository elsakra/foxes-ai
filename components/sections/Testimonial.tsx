    ...
    <section className="relative py-28 border-t border-[color:var(--line)]">
      <Container>
        ...
        >
          ...
          <blockquote className="mt-6 font-display text-[22px] sm:text-[30px] leading-[1.3] tracking-tight max-w-4xl">
            &ldquo;Before Foxes, we had no idea whether AI was recommending us
            or a competitor. Now we watch our mention rate climb every week and
            we know exactly why.&rdquo;
          </blockquote>
